...
function displayMenus(selectedDate)
{
    ...
    for (var i = 0; i < packet; i++)
    {
        ...
        var changeMenuOne = new Date('Wed Feb 18 2026 00:00:00 GMT+0700 (Waktu Indonesia Barat)');
...
function getMenuForDay(day)
{
    ...
    var menus = [
        [ // Sunday (0)
            ...
            { name: 'Lauk frozen tongseng ayam negeri', price: 12000, defaultQuantity: 0 },
            { name: 'Lauk frozen besengek ayam negeri', price: 12000, defaultQuantity: 0 },
            { name: 'Lauk frozen rica-rica ayam negeri', price: 12000, defaultQuantity: 0 },
            { name: 'Lauk Frozen gulai Ayam Negeri', price: 12000, defaultQuantity: 0 },
            { name: 'Lauk frozen oseng daun pepaya', price: 12000, defaultQuantity: 0 },
            { name: 'Lauk frozen tempe lombok ijo', price: 12000, defaultQuantity: 0 },
            ...
            { name: 'Galantin ayam', price: 12000, defaultQuantity: 0 },
            { name: 'Risol mayo frozen original 5 pcs', price: 15500, defaultQuantity: 0 },
            ...
            { name: 'Kaldu ayam kampung 100 ml', price: 3000, defaultQuantity: 0 },
            { name: 'Kaldu daging sapi 100 ml', price: 3000, defaultQuantity: 0 },
            // { name: 'Kaldu ikan tuna', price: 3000, defaultQuantity: 0 },
            { name: 'Kaldu ikan salmon 100 ml', price: 4000, defaultQuantity: 0 },
            { name: 'Kaldu ikan kakap 100 ml', price: 4000, defaultQuantity: 0 },
            ...
            { name: 'Ayam negeri giling 5 butir', price: 10000, defaultQuantity: 0 },
            
            { name: 'Ayam Negri Fillet 100 gram', price: 10000, defaultQuantity: 0 },
            { name: 'Hati ampela ayam kampung 1 pcs', price: 10000, defaultQuantity: 0 },
            ...
            { name: 'Beras Putih Organik 1 kg', price: 25000, defaultQuantity: 0 },
            { name: 'Beras Merah Organik 1 kg', price: 25000, defaultQuantity: 0 },
            { name: 'Beras Hitam Organik 1 kg', price: 35000, defaultQuantity: 0 },
...
function getMenuForDayTemporaryOne(day)
{
    ...
    var menus = [
        [ // Sunday (0)
            ...
            { name: '<sup>1</sup>&frasl;<sub>2</sub> Nasi tim sumsum sapi', price: 3000, defaultQuantity: quantityNasiTim_half },
            { name: '1 Nasi tim sumsum sapi', price: 6000, defaultQuantity: quantityNasiTim_1 },
            { name: 'Sup galantin ayam', price: 7000, defaultQuantity: quantitySup },
            // { name: 'Jus buah', price: 5000, defaultQuantity: quantityJusBuah },
            ...
            { name: 'Pepes ayam negri', price: 20000, defaultQuantity: 0 },
            { name: 'Pepes ikan lele', price: 20000, defaultQuantity: 0 },
            { name: 'Pepes ikan kembung', price: 20000, defaultQuantity: 0 },
            { name: 'Sate ayam', price: 20000, defaultQuantity: 0 },
            { name: 'Galantin ayam', price: 12000, defaultQuantity: 0 },
            { name: 'Risol mayo frozen original 5 pcs', price: 15500, defaultQuantity: 0 },
            { name: 'Risol mayo frozen pedas 5 pcs', price: 15500, defaultQuantity: 0 },
            { name: 'Makaroni schottle frozen', price: 3000, defaultQuantity: 0 },
            { name: 'Paket makaroni schottle frozen (isi 10 pcs)', price: 30000, defaultQuantity: 0 },
            { name: 'Tahu bakso 10 pcs', price: 22000, defaultQuantity: 0 },
        ...
        [ // Thursday (4) Kamis
            ...
            { name: '<sup>1</sup>&frasl;<sub>2</sub> Nasi tim ikan dory', price: 3000, defaultQuantity: quantityNasiTim_half },
            { name: '1 Nasi tim ikan dory', price: 6000, defaultQuantity: quantityNasiTim_1 },
            { name: 'Sup telur puyuh', price: 7000, defaultQuantity: quantitySup },
            // { name: 'Jus buah', price: 5000, defaultQuantity: quantityJusBuah },
        ...
        [ // Friday (5) Jumat
            ...
            { name: '<sup>1</sup>&frasl;<sub>2</sub> Nasi tim hati ayam kampung', price: 3000, defaultQuantity: quantityNasiTim_half },
            { name: '1 Nasi tim hati ayam kampung', price: 6000, defaultQuantity: quantityNasiTim_1 },
            { name: 'Sup ayam negri', price: 7000, defaultQuantity: quantitySup },
            // { name: 'Jus buah', price: 5000, defaultQuantity: quantityJusBuah },
